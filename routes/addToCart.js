...
router.post('/', async function (req, res, next) {
  try{
    ...
    if(!validated.error){
        var insertionResults = await functions.runQuery(`Insert into cart_food_items_mapper(cart_id, food_item_id, amount) values(${req.body.cart_id}, ${req.body.food_item_id}, ${req.body.amount})`);
